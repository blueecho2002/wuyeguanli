        ...
        <el-dialog title="添加维修信息" v-model="dialogFormVisible" style="width: 1500px;">
          <el-form :model="form">
            ...
            <el-form-item label="房屋id" :label-width="formLabelWidth">
              <el-input placeholder="请输入房屋ID" v-model="form.houseId" clearable style="width: 200px;" />
            ...
            <el-form-item label="设备" :label-width="formLabelWidth">
              <el-input placeholder="请输入设备名" v-model="form.deviceName" clearable style="width: 200px;" />
            ...
            <el-form-item label="维修信息" :label-width="formLabelWidth">
              <el-input placeholder="请输入维修信息" v-model="form.description" autocomplete="off"
...
export default {
  ...
  methods: {
    ...
    addRepair() {
      axios({
        method: 'get',
        url: 'http://localhost:8081/addRepair',
        params: {
    ...
    batchDelete() {
      ...
      this.$confirm('您确定要删除选定的报修记录吗？', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning',
      })
