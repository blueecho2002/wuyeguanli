    ...
    <el-container>
        ...
        <el-container>
            ...
            <el-main>
                ...
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
                    ...
                    <el-table-column label="操作" width="300px" style="text-align: center;">
                        <template slot-scope="scope">
                            <el-button size="mini" type="primary" @click="editRow(scope.row)">修改车位分配</el-button>
                ...
                <el-dialog title="添加车位信息" :visible.sync="dialogFormVisible" style="width: 1500px;">
                    <el-form :model="form">
...
export default {
    ...
    methods: {
        ...
        updatePark() {
            ...
            axios.post(`http://localhost:8082/park/updatePark`, this.form, {
                headers: {
        ...
        handleDelete(row) {
            // 在这里可以调用后端API删除学员
            axios.delete(`http://localhost:8082/park/deleteParkById/` + row.id)
                .then(response => {
        ...
        getAll() {
            ...
            // 发送异步请求
            axios.get("http://localhost:8082/park/selectPark/" + this.pagination.currentPage + '/' + this.pagination.pageSize + param).then((res) => {
        ...
        handleBatchDelete(selectedRows) {
            ...
            axios.post('http://localhost:8082/park/batchDeleteParks', deleteIds)
                .then(response => {
                    // 处理批量删除成功的情况
